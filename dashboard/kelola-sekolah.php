            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="/controller/schoolController.php?action=add" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nama Sekolah" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Kabupaten</label>
                                    <input class="form-control" type="text" placeholder="Kabupaten" name="regency">
                                </div>
                            </div>
